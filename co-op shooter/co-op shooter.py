...
pygame.display.set_caption("Co-op Shooter!")
...
BULLET_FIRE_SOUND = pygame.mixer.Sound('Assets/splash.mp3')                                      
...
try:
    ...
    YELLOW_SPACESHIP = pygame.transform.flip(YELLOW_SPACESHIP, True, False)
    ...
    RED_SPACESHIP = pygame.transform.flip(RED_SPACESHIP, True, False)
...
def draw_winner(text):
    ...
    WIN.blit(WINNER_FONT, (WIDTH/2 -draw_text.get_width.get_width()/2,HEIGHT/2 - draw_text.get_height()/2))   
    pygame.display.update()
